...
from track1_bicubic.modules.models import RRDB_Model,RRDB_Model_scale
from track1_bicubic.modules.utils import (load_yaml, set_memory_growth, imresize_np,
...
def main(gpu,yaml):
    ...
    def model_generator(cfg):
        ...
        type1 = {'esrgan_X2_bicubic': 2, 'esrgan_X3_bicubic': 3, 'esrgan_X4_bicubic': 4}
        type2 = {'esrgan_ea_X2_bicubic': 2, 'esrgan_ea_X3_bicubic': 3, 'esrgan_ea_X4_bicubic': 2}
...
def test(gpu,model,scale):
    ...
    esrgan_ea_yaml_dicts = {2:'./track1_bicubic/configs/esrgan_ea_x2_bicubic.yaml',
                  3:'./track1_bicubic/configs/esrgan_ea_x3_bicubic.yaml',
                  4:'./track1_bicubic/configs/esrgan_ea_x4_bicubic.yaml'}
    esrgan_yaml_dicts = {2: './track1_bicubic/configs/esrgan_x2_bicubic.yaml',
                            3: './track1_bicubic/configs/esrgan_x3_bicubic.yaml',
                            4: './track1_bicubic/configs/esrgan_x4_bicubic.yaml'}
